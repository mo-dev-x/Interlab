#!/bin/bash
#SBATCH --job-name=qwen-steering-v2
#SBATCH --output=slurm/logs/%j_steering_v2.out
#SBATCH --error=slurm/logs/%j_steering_v2.err
...
mkdir -p slurm/logs results/steering_v2 results/plots
