#!/bin/bash
#SBATCH --job-name=qwen-sae-v3
#SBATCH --output=slurm/logs/%j_train_v3.out
#SBATCH --error=slurm/logs/%j_train_v3.err
...
exec python scripts/train_sae.py --config configs/sae_train_v3.yaml
